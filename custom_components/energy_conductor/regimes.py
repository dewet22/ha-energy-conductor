...
to grid), above target normal Eco discharge continues. EC steers that one number:
  ...
  off_peak_charge (off-peak window OR dispatch): setpoint 100 — fill; off_peak/eta < export makes
...
REGIME_OFF_PEAK_CHARGE = "off_peak_charge"
